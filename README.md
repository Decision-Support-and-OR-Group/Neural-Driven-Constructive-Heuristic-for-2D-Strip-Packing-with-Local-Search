...
Test data used throughout the article can be found in test_data directory, and data used for neural network training and validation can be found in train_data directory.
